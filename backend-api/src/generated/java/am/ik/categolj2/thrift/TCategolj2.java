              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<TLink>(_list0.size);
                  TLink _elem1;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, findAllLinks_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (TLink _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (TLink _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<TLink>(_list5.size);
            TLink _elem6;
