define(function (require) {
    ...
    var Entries = require('js/admin/collections/Entries');
    var EntryListView = require('js/admin/views/entries/EntryListView');
    var EntryFormView = require('js/admin/views/entries/EntryFormView');
