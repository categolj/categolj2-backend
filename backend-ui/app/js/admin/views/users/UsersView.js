define(function (require) {
    ...
    var User = require('js/admin/models/User');
    var UserRowView = require('js/admin/views/users/UserRowView');
    var ErrorHandler = require('js/admin/views/ErrorHandler');

    var userTable = require('text!js/admin/templates/users/userTable.hbs');
