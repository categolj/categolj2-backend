define(function (require) {
    ...
    var EntryHistories = require('js/admin/collections/EntryHistories');
    var Categories = require('js/admin/collections/Categories');
    var Files = require('js/admin/collections/Files');
    var ButtonView = require('js/admin/views/ButtonView');
    var EntryPreviewModalView = require('js/admin/views/entries/EntryPreviewModalView');
    var AmazonSearchView = require('js/admin/views/entries/AmazonSearchView');
    var FileUploadView = require('js/admin/views/entries/FileUploadView');
    var ErrorHandler = require('js/admin/views/ErrorHandler');
    var AutoCompleteView = require('js/admin/views/AutoCompleteView');

    var entryForm = require('text!js/admin/templates/entries/entryForm.hbs');
    var entryShow = require('text!js/admin/templates/entries/entryShow.hbs');
    var entryTable = require('text!js/admin/templates/entries/entryTable.hbs');
    var amazonBookInserted = require('text!js/admin/templates/entries/amazonBookInserted.hbs');
    var fileInserted = require('text!js/admin/templates/entries/fileInserted.hbs');
