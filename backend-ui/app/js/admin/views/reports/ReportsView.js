define(function (require) {
    ...
    var AccessLogs = require('js/admin/collections/AccessLogs');
    var AccessLogReports = require('js/admin/collections/AccessLogReports');
    var CheckApiModalView = require('js/admin/views/reports/CheckApiModalView');
    require('dynatable');
