define(function (require) {
    ...
    var Loggers = require('js/admin/collections/Loggers');
    var Logger = require('js/admin/models/Logger');
    var LoggerRowView = require('js/admin/views/loggers/LoggerRowView');
    var ErrorHandler = require('js/admin/views/ErrorHandler');

    var loggerTable = require('text!js/admin/templates/loggers/loggerTable.hbs');
