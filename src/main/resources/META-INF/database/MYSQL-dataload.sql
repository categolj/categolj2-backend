-- -- (Begin) this is required for initial installation. remove comment at first time.
...
--
-- --
-- insert into link(url, link_name, version, created_date, created_by, last_modified_date, last_modified_by) values('https://github.com/making', 'Github', 0, now(), 'admin', now(), 'admin');
-- insert into link(url, link_name, version, created_date, created_by, last_modified_date, last_modified_by) values('https://twitter.com/making', 'Twitter', 0, now(), 'admin', now(), 'admin');
-- insert into link(url, link_name, version, created_date, created_by, last_modified_date, last_modified_by) values('http://www.slideshare.net/makingx', 'SlideShare', 0, now(), 'admin', now(), 'admin');
-- --
