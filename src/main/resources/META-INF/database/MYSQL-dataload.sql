...
--
-- insert into user (username, email, enabled, first_name, last_name, locked, password, version, created_date, created_by, last_modified_date, last_modified_by) values('making', 'makingx@gmail.com', true, 'Toshiaki', 'Maki', false, '$2a$10$kVelLNU0A6wo7.Rot5EhL.elYn3hROZnylkwl.fJ66rMBbS.4U4TO', 0, now(), 'admin', now(), 'admin');
-- insert into user_role(username, role_id) select 'making' as username, role_id from role;
--
-- insert into link(url, link_name, version, created_date, created_by, last_modified_date, last_modified_by) values('Twitter', 'https://twitter.com/making"', 0, now(), 'admin', now(), 'admin');
-- insert into link(url, link_name, version, created_date, created_by, last_modified_date, last_modified_by) values('Github', 'http://github.com/making', 0, now(), 'admin', now(), 'admin');
-- insert into link(url, link_name, version, created_date, created_by, last_modified_date, last_modified_by) values('SlideShare', 'http://www.slideshare.net/makingx"', 0, now(), 'admin', now(), 'admin');
--
